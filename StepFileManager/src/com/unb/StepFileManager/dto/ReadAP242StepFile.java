...
public class ReadAP242StepFile {
	/**
	 * JSDAI application program.
	 * Reads an STEP (ap242) physical file, prints instances of product entity, 
	...
	public static final void main(String[] args) throws jsdai.lang.SdaiException {
		System.out.println("Modulo para importar (AP242 para Java) y exportar (Java para ap242) archivos STEP");
		...
		repository.exportClearTextEncoding("/home/cristhian/Dropbox/workspaceISys/JsdaiRepository/Saida/saidaNew242.stp");
