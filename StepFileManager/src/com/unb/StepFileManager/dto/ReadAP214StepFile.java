...
public class ReadAP214StepFile {
	 ...
	 * Reads an STEP (ap214) physical file, prints instances of product entity, 
	...
	public static final void main(String[] args) throws jsdai.lang.SdaiException {
		System.out.println("Modulo para importar (AP214 para Java) y exportar (Java para ap214) archivos STEP");
