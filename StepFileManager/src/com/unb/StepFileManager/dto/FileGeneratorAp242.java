...
//import jsdai.SAp242_managed_model_based_3d_engineering_arm.*
			...
			SdaiTransaction transaction = session.startTransactionReadWriteAccess(); 
				...
				//SdaiRepository repo = session.importClearTextEncoding(null, "/home/cristhian/Dropbox/workspaceISys/JsdaiRepository/Entrada/ap242.stp", null);
						...
						repo.setOriginatingSystem(session.getSdaiImplementation().getName() + " " +
									...
									System.out.println("1. Session.getSdaiImplementation().getName():"+  session.getSdaiImplementation().getName());
									SdaiSession.setLogWriter(new PrintWriter(System.out, true));								
									A_string descriptions = repo.getDescription();
									System.out.println("2. A_string descriptions: "+  descriptions);
									descriptions.addByIndex(1, "3. Estructura de programa para generar un archivo p21 a partir de entidades ap242");												
									...
									ASdaiModel models = repo.getModels(); 
										...
										if (it_models.next()) {
												...
												System.out.println("4. Model <" + model.getName() + "> found"); 							
											} 
										//dictionaryModel.addAggregateByIndex(3, SA
										else {
												System.out.println("4. error: No SdaiModel found");
												}
									
						
						//SdaiModel dictionaryModel = null;
						SdaiModel dictionaryModel = null;
					//	dictionaryModel.getEntityExtentInstances(Ap242_managed_model_based_3d_engineering_arm.class);
						//model.getInstances(EProduct.class);
						//dictionaryModel.addAggregateByIndex(3, SAp242_managed_model_based_3d_engineering_arm.class);
						//dictionaryModel.createAggregateByIndex(it_models, Ap242_managed_model_based_3d_engineering_arm.class);
						
						
						//SdaiModel dictionaryModel = models.createAggregateAsCurrentMember(it_models, select)
						...
						//SchemaInstance dictionaryData =  new SchemaInstance();
